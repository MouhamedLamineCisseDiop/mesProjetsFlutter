...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(scaffoldBackgroundColor: Color.fromRGBO(41, 40, 40, 1)),
...
class _MyDecompteState extends State<MyDecompte> {
  int _compteur = 20; //Variable utilisée pour décompter
  bool _demarrer_decompte = false; //True-Démarrer ou False-Arreter le décompte
  late Timer _local_timer; //Timer utilisé pour les tickets
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: Text(
                  !(_demarrer_decompte) ? "Démarrer" : "Arreter",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 18,
                  ),
